...
# say safety/background/saving/summon_item

execute at @n[type=armor_stand,tag=fancyui.background.armor_stand] run summon item ~ ~ ~ {Item:{id:"minecraft:dirt",count:1b},Tags:["fancyui.saving.item"]}
