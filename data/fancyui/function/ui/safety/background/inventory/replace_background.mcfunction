...
#   Replace Background
#   
#   Purpose: To extract the background inventory item and start the replacement process
#
#   Input: None
#


# say safety/background/inventory/replace_background

summon minecraft:armor_stand ~ ~ ~ {equipment:{},Tags:["fancyui.background.armor_stand"]}

data modify entity @n[type=minecraft:armor_stand,tag=fancyui.background.armor_stand] equipment.mainhand set from entity @s Inventory[{components:{"minecraft:custom_data":{fancyui:{background:true}}}}]
