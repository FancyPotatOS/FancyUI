...
os.chdir("C:/Users/caleb/AppData/Roaming/.minecraft/resourcepacks/FancyUIResourcePack/assets/fancyui/models/item/demo/beacon/buttons/icons/effects")

effects = [x.replace(".png", "") for x in os.listdir("C:/Users/caleb/AppData/Roaming/.minecraft/resourcepacks/FancyUIResourcePack/assets/fancyui/textures/item/demo/beacon/button/icons/effects")]

model_entry = """          {
            "when": "_EFFECT_",
            "model": {
                "type": "minecraft:model",
                "model": "fancyui:item/demo/beacon/buttons/icons/effects/_EFFECT_"
              }
          }"""
...
for effect in effects:
    replacements["_EFFECT_"] = effect

    replace_file("_EFFECT_.json", replacements)

    coll.append(replace_values(model_entry, replacements))
